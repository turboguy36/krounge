...
public class TouchUserImageViewActivity extends Activity implements OnTouchListener{
...
//	private SnsAppInfo snsinfo;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		img_url = intent.getStringExtra("user_photo");
...
//		pd = ProgressDialog.show(TouchUserImageViewActivity.this, "", "", true);
		Thread thread = new Thread(new Runnable(){
			...
			public void run() {
				...
				int subUrl_start = img_url.lastIndexOf('/');

				String filename = img_url.substring(subUrl_start+1);
				String url_dir = img_url.substring(0, subUrl_start);
...
//		overviewReply.setText("댓글( "+reply_cnt+" )");
		...
		downButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String allURL = dir +"/ori_" +filename;
...
//		});
	...
	private class keyHandler extends Handler {
		...
		public void handleMessage(Message msg){
			...
			case SHOW_PRESS:
				if(doneButton.getVisibility() == 0x00000004 || doneButton.getVisibility() == 0x00000008){
					// invisible or gone
...
//					bottomBar.setVisibility(View.GONE);
			...
			case TAP:
				Log.i("tktktk", "handleMessage get a TAP");
				break;
