...
public class FileUploader {
	...
	public int uploadFile(String sourceFileUri, String user_id) {
		String upLoadServerUri = "http://www.knowledgetech.co.kr/etrihub/mobile/appdbbroker/appSendMessageWithFile.jsp";
		upLoadServerUri = upLoadServerUri + "?user_id=" +user_id;
